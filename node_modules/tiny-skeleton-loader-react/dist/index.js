...
function SkeletonLoader(_a) {
    ...
    return (React__default['default'].createElement("div", { className: css.skeleton, style: __assign({ width: width,
            height: height,
